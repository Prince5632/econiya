...
import '@/app/components/quote-modal.css';

const GetQuoteModal = dynamic(() => import('./GetQuoteModal'), { ssr: false });
                    ...
                    <div className="bg-white/98 backdrop-blur-xl border-t border-gray-100 shadow-xl overflow-y-auto max-h-[calc(85vh-72px)]">
                        <div className="max-w-7xl mx-auto px-4 py-4 space-y-1">
                            ...
                            <div className="pt-3 pb-1 px-2">
                                <button
                                    onClick={() => { closeMobile(); setShowQuoteModal(true); }}
                                    className="flex items-center justify-center gap-2 w-full bg-gradient-to-r from-red-600 to-red-500 text-white py-3.5 rounded-xl text-sm font-semibold shadow-lg shadow-red-200/50 hover:shadow-xl transition-all border-none cursor-pointer"
                                >
                                    Get a Quote
                                    <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M13 7l5 5m0 0l-5 5m5-5H6" />
